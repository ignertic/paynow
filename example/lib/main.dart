...
class _MyHomePageState extends State<MyHomePage> {
    ...
    return Scaffold(
      ...
      body: Stack(children: <Widget>[
                    ...
                    children: <Widget>[
                      ...
                      ArgonTimerButton(
                        ...
                        onTap: (startTimer, btnState) {
                          ...
                          Paynow paynow = Paynow(
                              ...
                              resultUrl: "http://google.co");
                          Payment payment =
                              paynow.createPayment("user", "user@email.com");
                          ...
                          paynow.sendMobile(
                            payment,
                            _phoneController.text ?? "0784442662",
                      ...
                      Row(
                        children: <Widget>[
                          ...
                          Text(
                            _status,
                            style: TextStyle(color: Colors.green, fontSize: 49),
                          ),
        ...
        Container(
          ...
          child: Column(children: _buildLoaders()),
        ),
        Container(
  ...
  List<GCircle> _buildLoaders() {
    this.loaders.clear();
    for (int i = 0; i < 3; i++) {
      this.loaders.add(GCircle(Colors.black));
    }
    return loaders;
  }
}
